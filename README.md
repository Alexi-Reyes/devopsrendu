...
Rendu pour le cours de docker devops.
...
-   `docker stats` pour voir les performances des containers

-   `http://localhost:8081/` pour adminer
-   `http://localhost:8080/containers/` pour voir les performances des containers
-   L'application se trouve sur `http://localhost:5173/`
